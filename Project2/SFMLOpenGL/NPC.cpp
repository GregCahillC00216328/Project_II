...
//
//mat4 mvp1, mvp2, mvp3, projection,
//view, model1, model2, model3;			// Model View Projection
//
//Font font;						// Game font
//
...
//	);
//	model1 = translate(model1, glm::vec3(-6.0f, 2.0f, -5.0f));
//	//x_moved = 0;
//	model2 = mat4(
//		1.0f					// Identity Matrix
//	);
//	model2 = translate(model1, glm::vec3(0.0f, 2.0f, -5.0f));
//	model3 = mat4(
//		1.0f					// Identity Matrix
//	);
//	model3 = translate(model1, glm::vec3(6.0f, 2.0f, -5.0f));
//	// Enable Depth Test
...
//	DEBUG_MSG(model1[0].x);
//	DEBUG_MSG(model1[0].y);
//	DEBUG_MSG(model1[0].z);
//
//	model1 = translate(model1, glm::vec3(0, 0, 0));
...
//	glUniformMatrix4fv(mvpID, 1, GL_FALSE, &mvp3[0][0]);
//
